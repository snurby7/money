...
export const TransactionQueries = {
  ...
  createNewTransaction: (
    ...
    query: `
      ...
      MERGE (${requestKey})-[relatesToAccount:${
      NodeRelationship.UsedAccount
    }]->(account)
      MERGE (${requestKey})-[relatesToCategory:${
      NodeRelationship.UsedCategory
    }]->(category)
      MERGE (${requestKey})-[relatesToPayee:${
      NodeRelationship.UsedPayee
    }]->(payee)
      RETURN ${requestKey}
    `,
    params: {
